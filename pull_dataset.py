...
def pull(kaggle_username, kaggle_apikey, kaggle_dataset_path):
    #API bit
    ...
    response = requests.get('https://www.kaggle.com/api/v1/datasets/download/' + kaggle_dataset_path, auth = basic, stream=True)
